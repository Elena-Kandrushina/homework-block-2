...
@pytest.mark.parametrize("account_card, expected", [("Visa Platinum 7000792289606361", "Visa Platinum  700 07 ** **** 0636"), ("Maestro 7000792289606361", "Maestro  700 07 ** **** 0636"), ("Счет 73654108430135874305", "Счет **7430")])
